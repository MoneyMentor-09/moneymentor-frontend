...
// // Helper: random string from given chars
...
// // Generate strong password with at least one char from each set
...
// test('sign up and log in with strong password', async ({ page }) => {
...
//   // 6. Wait for redirect to login page (or stay on same page)
...
//   console.log(`✅ User signed up and logged in successfully: ${email} / ${password}`);
// });
