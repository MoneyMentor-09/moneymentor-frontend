...
export function FloatingChatWidget() {
  ...
  const sendMessage = async () => {
    ...
    try {
      // Send message to your route.ts API
      ...
      // Use the 'response' property from your backend logic
      setMessages(prev => [
        ...prev,
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-80 h-96 bg-white rounded-xl shadow-xl border z-50 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3 bg-gray-50">
            ...
            {loading && (
              <div className="text-gray-500 text-sm italic px-2">MoneyMentor is typing...</div>
            )}
