...
const colorSchemes: Array<{
  ...
  { id: "default", name: "Default", description: "Standard color scheme", icon: "🎨" },
  { id: "protanopia", name: "Protanopia", description: "Red-blind (blue-yellow)", icon: "🔴" },
  { id: "deuteranopia", name: "Deuteranopia", description: "Green-blind (blue-purple)", icon: "🟢" },
  { id: "tritanopia", name: "Tritanopia", description: "Blue-blind (red-green)", icon: "🔵" },
  { id: "monochrome", name: "Monochrome", description: "Grayscale only", icon: "⚫" },
  { id: "high-contrast", name: "High Contrast", description: "Enhanced visibility", icon: "⚡" },
]
        ...
        <div className="p-6 space-y-6">
          ...
          <Card className="bg-muted/50">
            ...
            <CardContent className="text-xs text-muted-foreground space-y-2">
              <p>These accessibility settings persist across all pages and browser sessions.</p>
              <p>Color schemes are designed to support different types of color vision deficiency.</p>
            </CardContent>
          </Card>
        </div>
      </div>
